      ...
      <div class="flex space-x-3">
        ...
        <a 
          ...
          <div class="flex items-center gap-4 mt-3 text-sm text-gray-400">
            <!-- Like -->
            <button class="flex items-center gap-1 hover:text-red-400 transition like-btn ${isLiked ? 'text-red-400 liked' : ''}" data-action="like">
      ...
      <div class="flex items-start space-x-3">
        ...
        <div class="flex-1 min-w-0">
          <div class="flex items-center space-x-2 mb-1">
            ...
            <span class="text-gray-500 text-sm">${dayjs(reply.created_at).fromNow()}</span>
          </div>
          <div class="mb-3">
